  ...
  return (
    <div className="">
      ...
      <div className="  mt-3 p-2 flex justify-center items-center gap-x-2">
        ...
        }} className="border-2 rounded-3xl px-3 py-1">Pakistani</button>
        <button onClick={()=>{
          filterProduct("Italian");
        }}className="border-2 rounded-3xl px-3 py-1">Italian</button>
        <button onClick={()=>{
          filterProduct("Indian");
        }} className="border-2 rounded-3xl px-3 py-1">Indian</button>
      </div>
      <div >
        <div>
    ...
    <div className="w-full font-sans">
      ...
      <div className="relative w-full h-96">
        ...
        <div className="h-full flex flex-col items-center justify-center  text-center px-4">
          <h2 className="text-4xl font-bold mb-4">Process behind the making</h2>
          <p className="text-xl mb-8">See how only chefs cooks only the best momos</p>
